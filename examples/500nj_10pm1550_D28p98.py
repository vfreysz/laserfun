...
GDD_initial_ps2 = 28.960 # GDD initiale (ps^2)

time_window_ps = 5500 * fwhm_ps 
npts_pulse = 2**14 
...
resultats_propagation = NLSE(
    ...
    atol=1e-6, # Tolérance absolue un peu plus stricte
    rtol=1e-9  # Tolérance relative un peu plus stricte
)
